...
const SectionStyle1 = styled(Card)(({ theme }) => ({
  width: '100%',
  maxWidth: 300,
  minWidth: 210,
  display: 'flex',
...
export default function DashboardApp() {
  ...
  const submitSVG = (model,nm) => {
    ...
    if (nm === '') {nm = Date().toLocaleString()};

    set(ref(db, 'submitions/'+nm), {
    ...
    <>
      ...
      <RootStyle>
        <SectionStyle1>
          ...
          <Box sx={{ mb: 5, mr: 2, paddingLeft:'30px'}}>
            <AccountStyle>
              <Box sx={{mx: "auto" }}>
          ...
          <Box sx={{ mx: "auto", justifyContent: 'center', paddingBottom:'20px'}}>
            <ListItems />
          </Box>
      ...
      <SectionStyle>
        <Container maxWidth="xl">
          <Grid container spacing={3} sx={{paddingTop:'20px', paddingBottom:'10px'}}>
            <Grid item xs={8} md={8} lg={8} sm={8} xl={8} sx={{ height: '50%', width: '45%' }}>
              <Card>
                <Box sx={{ px: 3, pb: 1 }} dir="ltr">
                  ...
                  <Button className="ui primary button" sx={{ mt: 1.25 }} variant="outlined" onClick={(e) => submitSVG(model3,name)}>Submit</Button>
            ...
            <Grid item xs={4} sm={4} md={4} lg={4} xl={4}>
              <Card sx={{ width: '100%'}}>
              {
                    (showPolygon || showCircle || showRect || showBolt || showStar )? <Box className='nos' sx={{p: 2, width: '100%' }}>
                      <h2>{curr}</h2>
                    </Box> : null
                  }
                  {
                    showPolygon ? <Box className='nos' sx={{p: 2, width: '100%' }}>
                  ...
                  {
                    (showPolygon) ? <Box className='radius' sx={{p: 2, width: '100%' }}>
                      <h3>Radius</h3>
                      <Slider
                        onChange={polygon1}
                        value={Radius}
                  ...
                  {
                    showPolygon ? <Box className='transform' sx={{p: 2, width: '100%' }}>
                      <h3>Rotate</h3>
                      <Slider
                        onChange={polygon2}
                        size="small"
                  ...
                  {
                    (showCircle) ? <Box className='radius' sx={{p: 2, width: '100%' }}>
                      <h3>Radius</h3>
                      <Slider
                        onChange={circle0}
                        value={Radius}
                  ...
                  {
                    showRect ? <Box className='width' sx={{p: 2, width: '100%' }}>
                      <h3>Width</h3>
                      <Slider
                        onChange={rect0}
                        value={Width}
                  ...
                  {
                    showRect ? <Box className='height' sx={{ p: 2,width: '100%' }}>
                      <h3>Height</h3>
                      <Slider
                        onChange={rect1}
                        value={Height}
                  ...
                  {
                    showRect ? <Box className='round' sx={{ p: 2,width: '100%' }}>
                      <h3>Smooth Edge</h3>
                      <Slider
                        onChange={rect2}
                        value={Round}
                  ...
                  {
                    showRect ? <Box className='rotate' sx={{ p: 2,width: '100%' }}>
                      <h3>Rotate</h3>
                      <Slider
                        onChange={rect3}
                        value={Rotate}
                  ...
                  {
                    showBolt ? <Box className='radius' sx={{p: 2, width: '100%' }}>
                      <h3>Radius</h3>
                      <Slider
                        onChange={bolt0}
                        value={Radius}
                  ...
                  {
                    showBolt ? <Box className='nos' sx={{p: 2, width: '100%' }}>
                  ...
                  {
                    showBolt ? <Box className='rotate' sx={{ p: 2,width: '100%' }}>
                      <h3>Rotate</h3>
                      <Slider
                        onChange={bolt3}
                        value={Rotate}
                  ...
                  {
                    showStar ? <Box className='nos' sx={{p: 2, width: '100%' }}>
                  ...
                  {
                    showStar ? <Box className='radius' sx={{ p: 2,width: '100%' }}>
                      <h3>Outer Radius</h3>
                      <Slider
                        onChange={star1}
                        value={Radius}
                  ...
                  {
                    showStar ? <Box className='inner_radius' sx={{ p: 2,width: '100%' }}>
                      <h3>Inner Radius</h3>
                      <Slider
                        onChange={star2}
                        value={InnerRadius}
                  ...
                  {
                    showStar ? <Box className='rotate' sx={{ p: 2,width: '100%' }}>
                      <h3>Rotate</h3>
                      <Slider
                        onChange={star4}
                        value={Rotate}
                  ...
                  {
                    showHeart ? <Box className='radius' sx={{ p: 2,width: '100%' }}>
                      <h3>Radius</h3>
                      <Slider
                        onChange={heart0}
                        value={Radius}
                  ...
                  {
                    showHeart ? <Box className='angle' sx={{ p: 2,width: '100%' }}>
                      <h3>Angle</h3>
                      <Slider
                        onChange={heart1}
                        value={Angle}
                  ...
                  {
                    showHeart ? <Box className='rotate' sx={{ p: 2, width: '100%' }}>
                      <h3>Rotate</h3>
                      <Slider
                        onChange={heart2}
                        value={Rotate}
            ...
            {
              (curr !== '') ?
            <Grid item xs={8} sm={8} md={8} lg={8} xl={8} sx={{paddingBottom:'20px'}}>
              <Card sx={{width:'100%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                <Box sx={{py:1}} dir="ltr" justifyContent='center'>
                  <Joystick size={95} sticky={true} throttle={70} baseColor="grey" stickColor="black" move={handleMove}></Joystick>
                </Box>
              </Card>
            </Grid> : null}
          </Grid>  
